...
extension Defaults.Keys {
  ...
  static let aiFixTyposPrompt = Key<String>("aiFixTyposPrompt", default: AITextAction.fixTypos.defaultPrompt)
  static let aiRephrasePrompt = Key<String>("aiRephrasePrompt", default: AITextAction.rephraseFormal.defaultPrompt)
  static let aiSummarizePrompt = Key<String>("aiSummarizePrompt", default: AITextAction.summarize.defaultPrompt)
