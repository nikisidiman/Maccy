...
extension Defaults.Keys {
  ...
  static let openPreviewOnRightClick = Key<Bool>("openPreviewOnRightClick", default: false)
  ...
  static let previewCacheLimitMB = Key<Int>("previewCacheLimitMB", default: 200)
  static let previewWidth = Key<CGFloat>("previewWidth", default: 400)
  static let aiCustomPrompt = Key<String>("aiCustomPrompt", default: "")
  static let aiFixTyposPrompt = Key<String>("aiFixTyposPrompt", default: AIDefaultPrompts.fixTypos)
  static let aiRephrasePrompt = Key<String>("aiRephrasePrompt", default: AIDefaultPrompts.rephraseFormal)
  static let aiSummarizePrompt = Key<String>("aiSummarizePrompt", default: AIDefaultPrompts.summarize)
  ...
  static let translationNativeLanguage = Key<String>("translationNativeLanguage", default: "ru")
}
